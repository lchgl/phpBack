        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" name="introduce" row="5" required>{{$lesson['introduce']}}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <input type="text"  class="form-control" id="imgUrl" name="preview" value="{{$lesson['preview']}}">
                    </div>
                    <div>
                        <img id="imgHeadPhoto" src="{{$lesson['preview']}}" style="width: 160px; height: 170px; border: solid 1px #d2e2e2;"
                             alt="" />
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" name="click" required value="{{$lesson['click']}}" >
                    </div>
                </div>
            </div>
        </div>
